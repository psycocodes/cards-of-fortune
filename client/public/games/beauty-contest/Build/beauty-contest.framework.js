...
function _unityCall(funcNamePtr, argsJsonPtr) {
...
function _unitySendTx(funcNamePtr, argsJsonPtr) {
 var funcName = UTF8ToString(funcNamePtr);
 var argsJson = UTF8ToString(argsJsonPtr);
...
var asmLibraryArg = {
 ...
 "strftime": _strftime,
 "time": _time,
 "unityCall": _unityCall,
 "unitySendTx": _unitySendTx,
 "utime": _utime
};
...
if (!Object.getOwnPropertyDescriptor(Module, "webGLBridge")) Module["webGLBridge"] = function() {
 abort("'webGLBridge' was not exported. add it to EXPORTED_RUNTIME_METHODS (see the FAQ)");
};
